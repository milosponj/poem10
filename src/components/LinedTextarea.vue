        ...
        >
            ...
            >
                <p v-for="(line, index) in lines"
                   :key="index"
                   :class="line==exactSyllableCount ? 'lined-textarea__lines__line--exact' : 'lined-textarea__lines__line'"
                   v-html="line"
                ></p> 
            </div>
        </div>
    ...
    computed: {
        ...
        lines() {
            ...
            this.content.split('\n').forEach((line) => {
                ...
                lineNumbers.push(syllable(line));
...
.lined-textarea__lines__line--exact {
    font-weight: bold;
    color: green;
}
